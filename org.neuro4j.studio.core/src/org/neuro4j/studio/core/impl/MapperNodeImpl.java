 ...
 * <em><b>Mapper Node</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.neuro4j.studio.core.impl.MapperNodeImpl#getKeyValue <em>Key
 * Value</em>}</li>
 * <li>{@link org.neuro4j.studio.core.impl.MapperNodeImpl#getMainOutput <em>Main
 * Output</em>}</li>
 * </ul>
 * </p>
 * 
...
public class MapperNodeImpl extends ActionNodeImpl implements MapperNode {
	...
	/**
	 * The cached value of the '{@link #getKeyValue() <em>Key Value</em>}'
	...
	/**
	 * The cached value of the '{@link #getMainOutput() <em>Main Output</em>}'
	...
	public EList<KeyValuePair> getKeyValue() {
		if (keyValue == null) {
			keyValue = new EObjectResolvingEList<KeyValuePair>(
					KeyValuePair.class, this,
					Neuro4jPackage.MAPPER_NODE__KEY_VALUE);
		}
		return keyValue;
	}
	...
	public void notifyPropertyChanged(Object oldValue, Object newValue) {
		eNotify(new ENotificationImpl(this, Notification.SET,
				Neuro4jPackage.MAPPER_NODE__KEY_VALUE, oldValue, newValue));
	}
			...
			if (mainOutput != oldMainOutput) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							Neuro4jPackage.MAPPER_NODE__MAIN_OUTPUT,
							oldMainOutput, mainOutput));
			}
		}
		return mainOutput;
	}
	...
	public void setMainOutput(OperatorOutput newMainOutput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Neuro4jPackage.MAPPER_NODE__MAIN_OUTPUT, oldMainOutput,
					mainOutput));
	}
	...
	public void setNodeSpecificProperties(NodeXML entity) {
		...
		for (KeyValuePair kbp : list) {
			entity.addParameter(kbp.getValue(), kbp.getKey(), true);
		}
	}
	...
	public void getNodeSpecificProperties(NodeXML entity) {
		List<ParameterXML> keys = entity.getParameters();
		Iterator<ParameterXML> iterator = keys.iterator();
		while (iterator.hasNext()) {
			ParameterXML p = iterator.next();
			...
			if (value != null) {
				...
				KeyValuePair kvp = Neuro4jFactory.eINSTANCE
						.createKeyValuePair();
				kvp.setKey(value);
