...
public class PropetiesConstants {
   ...
   // public static final String N4J_CONSOLE_NODE_TYPE = "N4J_CONSOLE_NODE_TYPE";
    ...
    public static final String RELATION_ERROR_NAME = "ERROR";
    public static final String RELATION_COORDINATES_DELIMITER = "\\|";
    public static final String RELATION_COORDINATES_POINT_DELIMITER = ",";
}
