...
public class OutputNamesUtils {
    ...
    public static final String[] LOGIC_NODE_OUTPUTS_NAMES = new String[] { LogicNode.NEXT, LogicNode.ERROR };
    ...
    private static final String[] LOOP_NODE_OUTPUTS_NAMES = new String[] { LoopNode.EXIT, LoopNode.LOOP_EXIT };
    private static final String[] DECISION_NODE_OUTPUTS_NAMES = new String[] { DecisionNode.TRUE, DecisionNode.FALSE };
    ...
    public static Integer getIndexByValue(ActionNode actionNode, String propertyValue) {
        String[] names = getRelationsNames(actionNode);
        if (names != null)
        {
    ...
    private static String[] getEndNodesForCallNode(CallNode callNode)
    {
        ...
        if (null != flowName)
        {
            ...
            // } catch (SimpleWorkflowException e) {
            // e.printStackTrace();
