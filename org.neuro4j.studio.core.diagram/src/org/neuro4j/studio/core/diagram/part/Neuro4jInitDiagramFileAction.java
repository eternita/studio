 ...
 * @generated
 */
public class Neuro4jInitDiagramFileAction implements IObjectActionDelegate {
    ...
    public void run(IAction action) {
        ...
        Wizard wizard = new Neuro4jNewDiagramFileWizard(domainModelURI,
                diagramRoot, editingDomain);
        wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
                NetworkEditPart.MODEL_ID));
        Neuro4jDiagramEditorUtil.runWizard(getShell(), wizard, "InitDiagramFile"); //$NON-NLS-1$
    }
}
