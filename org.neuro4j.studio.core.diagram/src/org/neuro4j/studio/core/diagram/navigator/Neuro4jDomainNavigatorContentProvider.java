 ...
 * @generated
 */
public class Neuro4jDomainNavigatorContentProvider implements
     ...
     * @generated
     */
    public Neuro4jDomainNavigatorContentProvider() {
    ...
    public Object[] getChildren(Object parentElement) {
        ...
        if (parentElement instanceof Neuro4jDomainNavigatorItem) {
            return wrapEObjects(
                    myAdapterFctoryContentProvier.getChildren(((Neuro4jDomainNavigatorItem) parentElement)
    ...
    public Object[] wrapEObjects(Object[] objects, Object parentElement) {
        ...
        for (int i = 0; i < objects.length; i++) {
            if (objects[i] instanceof EObject) {
                result.add(new Neuro4jDomainNavigatorItem((EObject) objects[i],
