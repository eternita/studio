 ...
 * @generated
 */
public class Neuro4jNavigatorSorter extends ViewerSorter {
    ...
    public int category(Object element) {
        if (element instanceof Neuro4jNavigatorItem) {
            Neuro4jNavigatorItem item = (Neuro4jNavigatorItem) element;
            return Neuro4jVisualIDRegistry.getVisualID(item.getView());
        }
