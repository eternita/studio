 ...
 * @generated
 */
public class DecisionNodeDecisionNodeTrueOutputCompartmentCanonicalEditPolicy
    ...
    protected List getSemanticChildrenList() {
        ...
        List<Neuro4jNodeDescriptor> childDescriptors = Neuro4jDiagramUpdater
                .getDecisionNodeDecisionNodeTrueOutputCompartment_7008SemanticChildren(viewObject);
    ...
    private boolean isMyDiagramElement(View view) {
        return OperatorOutput3EditPart.VISUAL_ID == Neuro4jVisualIDRegistry
                .getVisualID(view);
    }
    ...
    protected void refreshSemantic() {
        ...
        List<Neuro4jNodeDescriptor> childDescriptors = Neuro4jDiagramUpdater
                .getDecisionNodeDecisionNodeTrueOutputCompartment_7008SemanticChildren((View) getHost()
                        .getModel());
