...
import org.neuro4j.studio.core.diagram.edit.policies.Neuro4jTextSelectionEditPolicy;
 ...
 * @generated
 */
public class OperatorOutputNameEditPart extends LabelEditPart implements
        ITextAwareEditPart {
    ...
    static {
        registerSnapBackPosition(
                Neuro4jVisualIDRegistry
                        .getType(org.neuro4j.studio.core.diagram.edit.parts.OperatorOutputNameEditPart.VISUAL_ID),
                new Point(0, 40));
    }
     ...
     * @generated
     */
    public OperatorOutputNameEditPart(View view) {
        super(view);
    }
    ...
    protected void createDefaultEditPolicies() {
        ...
        installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
                new Neuro4jTextSelectionEditPolicy());
        installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
                new NetworkEditPart.LinkLabelDragPolicy());
    }
    ...
    protected Image getLabelIcon() {
        ...
        return Neuro4jElementTypes.getImage(parserElement.eClass());
    }
    ...
    protected String getLabelText() {
        ...
        if (PropetiesConstants.RELATION_DEFAULT_NAME.equals(text)) {
            text = defaultText;
        }
        return text;
    }
    ...
    /**
     * Check if provided names of OutputOperation.
     * If names are predefined - not editable.
     * 
     * @generated NOT
     */
    protected boolean isEditable() {
        // return getParser() != null;
        DecorationNodeImpl decNode = (DecorationNodeImpl) this.getModel();

        boolean isEditable = (OutputNamesUtils.getRelationsNames(decNode
                .getElement().eContainer()) == null);
        OperatorOutputImpl output = (OperatorOutputImpl) decNode.getElement();
        if (isCircleRelation(output))
        {
            isEditable = false;
        }
        return isEditable;
    ...
    private boolean isCircleRelation(OperatorOutputImpl output)
    {
        if (output.eContainer() instanceof StandardNodeImpl && output.getTarget() instanceof StandardNodeImpl)
        {
            StandardNodeImpl source = (StandardNodeImpl) output.eContainer();
            StandardNodeImpl target = (StandardNodeImpl) output.getTarget();
            if (source.isCircleRelation() || target.isCircleRelation())
            {
                return true;
            }
        }
    ...
    protected DirectEditManager getManager() {
        if (manager == null) {
            setManager(new TextDirectEditManager2(this, null,
                    Neuro4jEditPartFactory.getTextCellEditorLocator(this)));
        }
        return manager;
    }
