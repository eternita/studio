 ...
 * @generated
 */
public class DecisionNodeDecisionNodeMainInputCanonicalEditPolicy extends
        CanonicalEditPolicy {
    ...
    protected List getSemanticChildrenList() {
        ...
        List<Neuro4jNodeDescriptor> childDescriptors = Neuro4jDiagramUpdater
                .getDecisionNodeDecisionNodeMainInput_7006SemanticChildren(viewObject);
    ...
    private boolean isMyDiagramElement(View view) {
        return OperatorInput2EditPart.VISUAL_ID == Neuro4jVisualIDRegistry
                .getVisualID(view);
    }
    ...
    protected void refreshSemantic() {
        ...
        List<Neuro4jNodeDescriptor> childDescriptors = Neuro4jDiagramUpdater
                .getDecisionNodeDecisionNodeMainInput_7006SemanticChildren((View) getHost()
                        .getModel());
