 ...
 * @generated
 */
public class DecisionNodeCompKeyOperatorDecisionEditPart extends
     ...
     * @generated
     */
    public DecisionNodeCompKeyOperatorDecisionEditPart(View view) {
        super(view);
    }
    ...
    protected String getLabelText() {
        ...
        // }
        DecisionNodeImpl dn = (DecisionNodeImpl) parserElement;
        if (dn.getOperator() != null)
        {
            String operator = dn.getOperator();
            DecisionOperators doperator = DecisionOperators.valueOf(operator);
            // for single operand like define string
            StringBuilder str = new StringBuilder();
            if (doperator.isSingleOperand())
            {
                str.append(doperator.getDisplayName()).append(" ").append(dn.getDecisionKey());

            } else {
                str.append(dn.getDecisionKey()).append(" ").append(doperator.getDisplayName()).append(" ").append(dn.getCompKey());
            }
            ...
            parser = Neuro4jParserProvider
                    .getParser(
                            ...
                            Neuro4jVisualIDRegistry
                                    .getType(org.neuro4j.studio.core.diagram.edit.parts.DecisionNodeCompKeyOperatorDecisionEditPart.VISUAL_ID));
        }
        return parser;
    }
