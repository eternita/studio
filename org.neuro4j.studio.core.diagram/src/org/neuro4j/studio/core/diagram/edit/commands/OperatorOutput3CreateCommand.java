 ...
 * @generated
 */
public class OperatorOutput3CreateCommand extends EditElementCommand {

    /**
     * @generated
     */
    public OperatorOutput3CreateCommand(CreateElementRequest req) {
    ...
    public boolean canExecute() {
        ...
        if (container.getMainTrueOutput() != null) {
            return false;
        }
        return true;
    ...
    protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
        ...
        childHolder.setMainTrueOutput(newElement);
