 ...
 * @generated
 */
public class CallNodeDynamicFlowNameFlowNameEditPart extends
     ...
     * @generated
     */
    public CallNodeDynamicFlowNameFlowNameEditPart(View view) {
        super(view);
    }
    ...
    protected void setLabelTextHelper(IFigure figure, String text) {
        if (figure instanceof WrappingLabel) {
            ((WrappingLabel) figure).setText(beautifyName(text));
        } else if (figure instanceof Label) {
            ((Label) figure).setText(beautifyName(text));
        } else {
            getLabelDelegate().setText(beautifyName(text));
        }
    }
            ...
            parser = Neuro4jParserProvider
                    .getParser(
                            ...
                            Neuro4jVisualIDRegistry
                                    .getType(org.neuro4j.studio.core.diagram.edit.parts.CallNodeDynamicFlowNameFlowNameEditPart.VISUAL_ID));
        }
        return parser;
    }
    ...
    {
        CallNodeEditPart parent = (CallNodeEditPart) getParent();
        ShapeImpl shape = (ShapeImpl) parent.getModel();
        CallNode callNode = (CallNode) shape.getElement();
        ...
        if (index > 1) {
            flowName = flowName.substring(index + 1);
        } else {
            return name;
        }
        String dynamicName = callNode.getDynamicFlowName();
        if (dynamicName == null)
        {
            return flowName;
        }
        return dynamicName + " " + flowName;
    }
