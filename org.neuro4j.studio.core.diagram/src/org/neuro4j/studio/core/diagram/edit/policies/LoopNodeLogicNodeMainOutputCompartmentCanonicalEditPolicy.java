 ...
 * @generated
 */
public class LoopNodeLogicNodeMainOutputCompartmentCanonicalEditPolicy extends
        CanonicalEditPolicy {
    ...
    protected List getSemanticChildrenList() {
        ...
        List<Neuro4jNodeDescriptor> childDescriptors = Neuro4jDiagramUpdater
                .getLoopNodeLoopNodeLoopOutputCompartment_7009SemanticChildren(viewObject);
    ...
    private boolean isMyDiagramElement(View view) {
        return OperatorOutput5EditPart.VISUAL_ID == Neuro4jVisualIDRegistry
                .getVisualID(view);
    }
    ...
    protected void refreshSemantic() {
        ...
        List<Neuro4jNodeDescriptor> childDescriptors = Neuro4jDiagramUpdater
                .getLoopNodeLoopNodeLoopOutputCompartment_7009SemanticChildren((View) getHost()
                        .getModel());
