 ...
 * @generated
 */
public class OperatorInput3CreateCommand extends EditElementCommand {

    /**
     * @generated
     */
    public OperatorInput3CreateCommand(CreateElementRequest req) {
    ...
    public boolean canExecute() {
        ...
        if (container.getLoopInput() != null) {
            return false;
        }
        return true;
    ...
    protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
        ...
        childHolder.setLoopInput(newElement);
