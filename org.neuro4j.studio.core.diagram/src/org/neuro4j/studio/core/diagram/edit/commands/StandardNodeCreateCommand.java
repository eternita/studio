...
public class StandardNodeCreateCommand extends JoinNodeCreateCommand {
     ...
     * @generated
     */
    public StandardNodeCreateCommand(CreateElementRequest req, int type) {
        super(req);
        this.type = type;
    }

    public StandardNodeCreateCommand(CreateRelationshipRequest req,
    ...
    protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
        ...
        StandardNode newElement = Neuro4jFactory.eINSTANCE.createStandardNode();
        newElement.setType(type);
        newElement.update();

        if (getElementToEdit() instanceof StandardNodeImpl)
        {
            StandardNodeImpl st = (StandardNodeImpl) getElementToEdit();

            Network owner = st.getNetwork();
