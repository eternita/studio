 ...
 * @generated
 */
public class LoopNodeLoopNodeMainInputCompartmentCanonicalEditPolicy extends
        CanonicalEditPolicy {
    ...
    protected EStructuralFeature getFeatureToSynchronize() {
        return Neuro4jPackage.eINSTANCE.getActionNode_Input();
    }
    ...
    protected List getSemanticChildrenList() {
        ...
        List<Neuro4jNodeDescriptor> childDescriptors = Neuro4jDiagramUpdater
                .getLoopNodeLoopNodeMainInputCompartment_7005SemanticChildren(viewObject);
    ...
    private boolean isMyDiagramElement(View view) {
        return OperatorInput4EditPart.VISUAL_ID == Neuro4jVisualIDRegistry
                .getVisualID(view);
    }
    ...
    protected void refreshSemantic() {
        ...
        List<Neuro4jNodeDescriptor> childDescriptors = Neuro4jDiagramUpdater
                .getLoopNodeLoopNodeMainInputCompartment_7005SemanticChildren((View) getHost()
                        .getModel());
