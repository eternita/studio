 ...
 * @generated
 */
public class DecisionNodeDecisionNodeFalseOutputCompartmentCanonicalEditPolicy
    ...
    protected List getSemanticChildrenList() {
        ...
        List<Neuro4jNodeDescriptor> childDescriptors = Neuro4jDiagramUpdater
                .getDecisionNodeDecisionNodeFalseOutputCompartment_7007SemanticChildren(viewObject);
    ...
    private boolean isMyDiagramElement(View view) {
        return OperatorOutput2EditPart.VISUAL_ID == Neuro4jVisualIDRegistry
                .getVisualID(view);
    }
    ...
    protected void refreshSemantic() {
        ...
        List<Neuro4jNodeDescriptor> childDescriptors = Neuro4jDiagramUpdater
                .getDecisionNodeDecisionNodeFalseOutputCompartment_7007SemanticChildren((View) getHost()
                        .getModel());
