 ...
 * @generated
 */
public class OperatorOutput8CreateCommand extends EditElementCommand {

    /**
     * @generated
     */
    public OperatorOutput8CreateCommand(CreateElementRequest req) {
    ...
    public boolean canExecute() {
        JoinNode container = (JoinNode) getElementToEdit();
    ...
    protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
        ...
        JoinNode childHolder = (JoinNode) getElementToEdit();
