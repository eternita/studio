 ...
 * @generated
 */
public class JoinNodeJoinNodeMainOutputCompartmentCanonicalEditPolicy extends
        CanonicalEditPolicy {
    ...
    protected List getSemanticChildrenList() {
        ...
        List<Neuro4jNodeDescriptor> childDescriptors = Neuro4jDiagramUpdater
                .getJoinNodeJoinNodeMainOutputCompartment_7002SemanticChildren(viewObject);
    ...
    private boolean isMyDiagramElement(View view) {
        return OperatorOutput8EditPart.VISUAL_ID == Neuro4jVisualIDRegistry
                .getVisualID(view);
    }
    ...
    protected void refreshSemantic() {
        ...
        List<Neuro4jNodeDescriptor> childDescriptors = Neuro4jDiagramUpdater
                .getJoinNodeJoinNodeMainOutputCompartment_7002SemanticChildren((View) getHost()
                        .getModel());
