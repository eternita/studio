 ...
 * @generated
 */
public class StartNodeStartNodeMainOutputCompartmentCanonicalEditPolicy extends
        CanonicalEditPolicy {
    ...
    protected List getSemanticChildrenList() {
        ...
        List<Neuro4jNodeDescriptor> childDescriptors = Neuro4jDiagramUpdater
                .getStartNodeStartNodeMainOutputCompartment_7001SemanticChildren(viewObject);
    ...
    private boolean isMyDiagramElement(View view) {
        return OperatorOutput9EditPart.VISUAL_ID == Neuro4jVisualIDRegistry
                .getVisualID(view);
    }
    ...
    protected void refreshSemantic() {
        ...
        List<Neuro4jNodeDescriptor> childDescriptors = Neuro4jDiagramUpdater
                .getStartNodeStartNodeMainOutputCompartment_7001SemanticChildren((View) getHost()
                        .getModel());
