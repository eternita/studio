 ...
 * @generated
 */
public class FollowByRelationNodeNameEditPart extends CompartmentEditPart
     ...
     * @generated
     */
    public FollowByRelationNodeNameEditPart(View view) {
        super(view);
    }
    ...
    public IParser getParser() {
        if (parser == null) {
            parser = Neuro4jParserProvider
                    .getParser(
                            Neuro4jElementTypes.FollowByRelationNode_2011,
                            getParserElement(),
                            Neuro4jVisualIDRegistry
                                    .getType(org.neuro4j.studio.core.diagram.edit.parts.FollowByRelationNodeNameEditPart.VISUAL_ID));
        }
        return parser;
    }
