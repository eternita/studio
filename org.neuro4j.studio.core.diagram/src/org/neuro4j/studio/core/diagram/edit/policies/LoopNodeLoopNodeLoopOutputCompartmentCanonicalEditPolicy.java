 ...
 * @generated
 */
public class LoopNodeLoopNodeLoopOutputCompartmentCanonicalEditPolicy extends
        CanonicalEditPolicy {
    ...
    protected List getSemanticChildrenList() {
        ...
        List<Neuro4jNodeDescriptor> childDescriptors = Neuro4jDiagramUpdater
                .getLoopNodeLoopNodeMainOutputCompartment_7010SemanticChildren(viewObject);
    ...
    private boolean isMyDiagramElement(View view) {
        return OperatorOutput4EditPart.VISUAL_ID == Neuro4jVisualIDRegistry
                .getVisualID(view);
    }
    ...
    protected void refreshSemantic() {
        ...
        List<Neuro4jNodeDescriptor> childDescriptors = Neuro4jDiagramUpdater
                .getLoopNodeLoopNodeMainOutputCompartment_7010SemanticChildren((View) getHost()
                        .getModel());
