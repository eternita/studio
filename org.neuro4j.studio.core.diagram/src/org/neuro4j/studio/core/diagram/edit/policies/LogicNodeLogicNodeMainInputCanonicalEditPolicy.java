 ...
 * @generated
 */
public class LogicNodeLogicNodeMainInputCanonicalEditPolicy extends
        CanonicalEditPolicy {
    ...
    protected List getSemanticChildrenList() {
        ...
        List<Neuro4jNodeDescriptor> childDescriptors = Neuro4jDiagramUpdater
                .getLogicNodeLogicNodeMainInput_7012SemanticChildren(viewObject);
    ...
    private boolean isMyDiagramElement(View view) {
        return OperatorInput5EditPart.VISUAL_ID == Neuro4jVisualIDRegistry
                .getVisualID(view);
    }
    ...
    protected void refreshSemantic() {
        ...
        List<Neuro4jNodeDescriptor> childDescriptors = Neuro4jDiagramUpdater
                .getLogicNodeLogicNodeMainInput_7012SemanticChildren((View) getHost()
                        .getModel());
