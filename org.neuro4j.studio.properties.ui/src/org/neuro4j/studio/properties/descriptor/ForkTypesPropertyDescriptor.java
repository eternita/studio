...
public class ForkTypesPropertyDescriptor extends ComboBoxPropertyDescriptor {

	public  String[] values = {"", "false", "true"};
	
    public ForkTypesPropertyDescriptor(Object id, String displayName,
            String[] labelsArray) {
