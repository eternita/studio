...
public class DecisionCompTypePropertyDescriptor extends ComboBoxPropertyDescriptor {

    public DecisionCompTypePropertyDescriptor(Object id, String displayName,
            String[] labelsArray) {
    ...
    {
        return DecisionCompTypes.operators();
    }
}
