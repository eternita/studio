...
public class StartTypesPropertyDescriptor extends ComboBoxPropertyDescriptor {

    public StartTypesPropertyDescriptor(Object id, String displayName,
            String[] labelsArray) {
