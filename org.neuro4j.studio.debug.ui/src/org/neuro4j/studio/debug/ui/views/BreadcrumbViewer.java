 ...
 * selected.
 * <p>
 * Content providers for breadcrumb viewers must implement the <code>ITreePathContentProvider</code> interface.
 * </p>
 * <p>
...
public abstract class BreadcrumbViewer extends StructuredViewer {
    ...
    /**
     * The shell used for the shown drop down or <code>null</code> if no drop down is shown at the moment.
     * 
    ...
    /*
     * @see
     * org.eclipse.jface.viewers.StructuredViewer#assertContentProviderType(org.eclipse.jface.viewers.IContentProvider)
     */
     ...
     * 
     * @param next
     *        <code>true</code> if the next element should be selected, otherwise the previous
