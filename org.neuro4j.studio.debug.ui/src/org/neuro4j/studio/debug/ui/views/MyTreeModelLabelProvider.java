 ...
 * @since 3.3
 */
public class MyTreeModelLabelProvider extends ColumnLabelProvider
        implements ITreeModelLabelProvider, IModelChangedListener
{
     ...
     * 
     * @param viewer
     *        Viewer that this label provider is used with.
     */
    public MyTreeModelLabelProvider(IInternalTreeModelViewer viewer) {
        fViewer = viewer;
     ...
     * 
     * @param descriptor
     *        image descriptor or <code>null</code>
     ...
     * @param labels
     *        Array of labels. The array cannot to be <code>null</code>, but values within the array may be.
     * @param images
     *        Array of image descriptors, may be <code>null</code>.
     * @param fontDatas
     *        Array of fond data objects, may be <code>null</code>.
     * @param foregrounds
     *        Array of RGB values for foreground colors, may be <code>null</code>.
     * @param backgrounds
     *        Array of RGB values for background colors, may be <code>null</code>.
     * @param checked
     *        Whether given item should be checked.
     * @param grayed
     *        Whether given item's checkbox should be grayed.
     */
     ...
     * @param searchFullPath
     *        flag whether to look for the element in the full path
     *        of the update
     */
     ...
     * 
     * @param update
     *        Update that is to be completed.
     */
            ...
            fViewer.getDisplay().asyncExec(new Runnable() {
                public void run() {
                    if (isDisposed())
                        return;
                    List updates = null;
                    synchronized (MyTreeModelLabelProvider.this) {
                        updates = fComplete;
                        fComplete = null;
                    }
