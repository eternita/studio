...
public class FlowLaunchView extends AbstractDebugView implements ISelectionChangedListener, IPerspectiveListener2, IPageListener, IShowInTarget, IShowInSource,
        IShowInTargetList, IPartListener2, IViewerUpdateListener {
    ...
    private class BreadcrumbPage extends Page {
        ...
        public void createControl(Composite parent) {
            fCrumb = new LaunchViewBreadcrumb(FlowLaunchView.this, (TreeModelViewer) getViewer(), fTreeViewerDebugContextProvider);
    ...
    void showBreadcrumbPage() {
        ...
        if (rec != null && !fBreadcrumbPage.equals(getCurrentPage())) {
            ...
            fBreadcrumbPage.fCrumb.debugContextChanged(new DebugContextEventAdapter(
