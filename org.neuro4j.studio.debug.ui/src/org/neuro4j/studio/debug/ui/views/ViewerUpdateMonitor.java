...
public abstract class ViewerUpdateMonitor extends Request implements IViewerUpdate {
     ...
     *        content provider
     * @param viewerInput
     *        Viewer input for update
     * @param elementPath
     *        path to associated model element - empty for root element
     * @param element
     *        associated model element
     * @param elementContentProvider
     *        Content provider for this update.
     * @param context
     *        Presentation contest for this update
     */
     ...
     * 
     * @param update
     *        request to coalesce with this request
     ...
     * 
     * @param delegated
     *        whether the update has been delegated
     * @since 3.4
     */
