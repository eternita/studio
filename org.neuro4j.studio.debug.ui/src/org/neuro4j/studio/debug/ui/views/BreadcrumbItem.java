 ...
 * <p>
 * The item shows a label and an image. It also has the ability to expand, that is to open a drop down menu.
 * </p>
 * <p>
 * The drop down allows to select any child of the items input element. The item shows the label and icon of its data
 * element, if any.
 * </p>
 * 
 * @since 3.5
...
class BreadcrumbItem extends Item {
     ...
     * 
     * @param state
     *        <code>true</code> if it has focus, <code>false</code> otherwise
     */
     ...
     * 
     * @param isLast
     *        <code>true</code> if this is the last item, <code>false</code> otherwise
     */
