...
public class ChangeVariableValueAction extends SelectionProviderAction {
     ...
     * 
     * @param view
     *        the variables view in which this action will appear
     */
     ...
     * 
     * @param variable
     *        run the action on the given variable
     */
     ...
     * contributed a variable value editor via extension. Returns <code>true</code> if a delegate handled the edit,
     * <code>false</code> if the variable still needs to be edited.
     * 
     * @param shell
     *        a shell for prompting the user
