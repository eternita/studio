...
import org.neuro4j.studio.debug.ui.views.VirtualFindAction;
//import org.eclipse.debug.internal.ui.viewers.model.provisional.TreeModelViewer;

/**
 * This class implements the breakpoints view.
 */
public class FlowBreakpointsView extends VariablesView implements IBreakpointManagerListener, IBreakpointsListener {
    ...
    protected String getPresentationContextId() {
        ...
        return "org.neuro4j.studio.debug.ui.BreakpointView";
    }
     ...
     * 
     * @see
     * org.eclipse.debug.internal.ui.views.variables.VariablesView#configureToolBar(org.eclipse.jface.action.IToolBarManager
     * )
     */
     ...
     * 
     * @see
     * org.eclipse.debug.internal.ui.views.variables.VariablesView#fillContextMenu(org.eclipse.jface.action.IMenuManager
     * )
     */
     ...
     * 
     * @see
     * org.eclipse.debug.internal.ui.views.variables.VariablesView#contextActivated(org.eclipse.jface.viewers.ISelection
     * )
     */
     ...
     * 
     * @see
     * org.eclipse.debug.internal.ui.views.variables.VariablesView#viewerInputUpdateComplete(org.eclipse.debug.internal
     * .ui.viewers.model.provisional.IViewerInputUpdate)
     */
     ...
     *        whether or not this view should track the debug view's selection.
     */
     ...
     * 
     * @param viewer
     *        the viewer to add drag and drop support to
     */
     ...
     * 
     * @param organizers
     *        the organizers, can be <code>null</code>.
     */
     ...
     * 
     * @param filter
     *        the selection to act as a filter
     */
     ...
     * 
     *         TODO Remove in favor of using <code>TreeItem</code>s and <code>TreePath</code>s to determine paste
     *         targets
     */
     ...
     * 
     * @param target
     *        target of the paste, either a IBreakpointContainer,
     ...
     * @return the first found container that includes the breakpoint that allows removal, or <code>null</code> if none
     *         found
     * @since 3.3
     */
     ...
     * 
     * @param path
     *        the path to get the container for
     ...
     * <p>
     * A drop target can be either a <code>IBreakpointContainer</code> or an <code>IBreakpoint</code>. This method
     * always checks the entire hierarchy of the tree path for the specified target in the event one of the parent
     * element does not support dropping.
     * </p>
     * 
     * @param path
     *        the path
     * @param breakpoint
     *        the breakpoint
     * @return <code>true</code> if there is a parent container available for the drop target <code>false</code>
     *         otherwise
     */
     ...
     * 
     * @param items
     *        the tree paths to check if they can be dragged
    ...
    /**
     * Performs the actual removal of breakpoints from their respective (removable) containers on a successful drag
     * operation
     * 
     * @param paths
     *        the tree paths to drag
     * @since 3.3
     */
     ...
     * 
     * @param target
     *        the target to add the selection of breakpoints to
     * @param selection
     ...
     * @param selection
     *        the selection to see if we can drop
    ...
    // public void removeBreakpoints(FlowLineBreakpointAdapter[] breakpoints)
    // {
    // //selection.getFirstElement()
    // ModelDelta parent = new ModelDelta(getTreeModelViewer().getInput(), IModelDelta.NO_CHANGE);
    //
    // // ModelDelta stateDelta = new ModelDelta(breakpoints[0], IModelDelta.REMOVED);
    // // stateDelta.set
    // ModelDelta childDelta = parent.addNode(breakpoints[0], IModelDelta.REMOVED|IModelDelta.UNINSTALL );
    //
    // ((TreeModelContentProvider)getTreeModelViewer().getContentProvider()).getBreakpointManagerContentProvider().breakpointsRemoved(breakpoints,
    // null);
    // // stateDelta.
    // getTreeModelViewer().updateViewer(childDelta);
    //
    //
    //
    //
    ...
    public void breakpointsAdded(IBreakpoint[] breakpoints) {
        if (getTreeModelViewer() != null)
        {
            ModelDelta parent = new ModelDelta(getTreeModelViewer().getInput(), IModelDelta.NO_CHANGE);

            ModelDelta childDelta = parent.addNode(breakpoints[0], IModelDelta.ADDED | IModelDelta.INSTALL);

            getTreeModelViewer().updateViewer(parent);
        }
    ...
    @Override
    public void breakpointsRemoved(IBreakpoint[] breakpoints, IMarkerDelta[] arg1) {
        ...
        for (IBreakpoint bp : breakpoints)
        {
            if (getTreeModelViewer() != null)
            {
                ...
                ModelDelta childDelta = parent.addNode(bp, IModelDelta.REMOVED | IModelDelta.UNINSTALL);
