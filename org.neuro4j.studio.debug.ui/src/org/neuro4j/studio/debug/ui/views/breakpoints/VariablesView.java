...
public class VariablesView extends AbstractDebugView implements IDebugContextListener,
    ...
    class Visitor implements IModelDeltaVisitor {
         ...
         * 
         * @see
         * org.eclipse.debug.internal.ui.viewers.provisional.IModelDeltaVisitor#visit(org.eclipse.debug.internal.ui.
         * viewers.provisional.IModelDelta, int)
         */
    ...
    /**
     * Called when the viewer input update is completed. Unlike {@link #setViewerInput(Object)}, it allows overriding
     * classes
     * to examine the context for which the update was calculated.
     * 
     * @param update
     *        Completed viewer input update.
     */
     ...
     * 
     * @param viewer
     *        the viewer to add drag/drop support to.
     * @since 3.4
     */
     ...
     * 
     * @param memento
     *        Memento to read sash weights from
     ...
     * 
     * @param parent
     *        Viewer's parent control
     * @return The created viewer.
     */
    protected TreeModelViewer createTreeViewer(Composite parent) {

        int style = getViewerStyle();
        fPresentationContext = new FlowDebugModelPresentationContext(getPresentationContextId(), this, fModelPresentation);
     ...
     * 
     * @param orientation
     *        Detail pane orientation to set.
     * 
     ...
     * 
     * @param actionID
     *        Action ID that the given action implements.
     * @param action
    ...
    /**
     * Returns the label to use for the action that toggles the view layout to be the tree viewer only (detail pane is
     * hidden).
     ...
     * 
     * @see
     * org.eclipse.debug.internal.ui.views.IDebugExceptionHandler#handleException(org.eclipse.debug.core.DebugException)
     */
     ...
     * 
     * @param flag
     *        If true, turns the logical structures on.
     */
     ...
     * 
     * @see
     * org.eclipse.debug.internal.ui.viewers.provisional.IModelChangedListener#modelChanged(org.eclipse.debug.internal
     * .ui.viewers.provisional.IModelDelta)
     */
    ...
    /*
     * @see
     * org.eclipse.debug.internal.ui.views.variables.details.IDetailPaneContainer2#setSelectionProvider(org.eclipse.
     * jface.viewers.ISelectionProvider)
     */
    ...
    // VariablesView.this.setViewer(viewer);
    // }
    //
    // public Control getControl()
    // {
    // return VariablesView.this.getDefaultControl();
    // }
    //
    // public void setFocus()
    // {
    // Viewer viewer = VariablesView.this.getViewer();
    // if (viewer != null) {
